...
```plain text
공부를 위해 검색을 하며 수많은 블로그를 읽으며 혼란스러운 경우가 많았습니다.
누가 옳은지, 어떤 말이 맞는지 알기 어려웠습니다.
그래서 책/공식문서를 바탕으로 올바른 자료를 찾아 정리하기 시작했습니다.

모르는 개념을 검색하다 보면 같은 키워드를 끝없이 반복하게 됩니다.
그 시간을 줄이고, 내가 직접 기록한 흔적을 남기고 싶었습니다.
